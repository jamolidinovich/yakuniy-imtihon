          ...
          <div>
            ...
            <div className="flex">
              ...
              <div className="ml-14 mt-[-10px]">
                ...
                <br />
                <button className="add mt-2">Add to cart</button>
                <br />
...
//     dispatch(addToWatchlist(item)); // Reduxga addToWatchlist actionni yuborish
//     alert("Mahsulot Watchlistga qo'shildi!"); // Foydalanuvchiga bildirish
//   };
//   return (
//     <div>
//       <AllHeader />
...
//                 <button className="now mt-2">Buy It Now</button>
//                 <br />
//                 <button className="add mt-2" onClick={handleAdd}>
//                   Add to cart
//                 </button>
//                 <br />
//                 <button className="to mt-2" onClick={handleAddWatchlist}>
//                   Add to Watchlist
//                 </button>
//               </div>
//             </div>
